...
export const BRAND: BrandConfig = {
  businessName: "ARUN'S MARIA GOLD",
  tagline: "Your Trusted Jewellery Store in Changanassery",
  description:
    "ARUN'S MARIA GOLD is Changanassery's trusted destination for gold, diamond and silver jewellery. Serving Changanassery and surrounding areas with timeless craftsmanship for every celebration — from weddings and festivals to everyday elegance.",
  ...
  address: "Central Junction, Chingavanam, Kerala 686531",
  city: "Changanassery",
  state: "Kerala",
  pincode: "686531",

  phone: "+918590253112",
  whatsapp: "918590253112",
  email: "",

  mapsLink:
    "https://share.google/yttXJdv5knlmGz46F",
  ...
  seo: {
    title: "ARUN'S MARIA GOLD | Gold & Diamond Jewellery in Changanassery",
    description:
      "ARUN'S MARIA GOLD — Changanassery's premier jewellery store. Exquisite gold, diamond and silver collections for every occasion. Visit us in Changanassery, Kerala.",
    keywords: [
      "ARUN'S MARIA GOLD",
    ...
    canonical: "https://aruns-maria-gold-changanassery.vercel.app",
  ...
  whatsappMessage:
    "Hello ARUN'S MARIA GOLD, I'd like to know more about your jewellery collections.",
};
